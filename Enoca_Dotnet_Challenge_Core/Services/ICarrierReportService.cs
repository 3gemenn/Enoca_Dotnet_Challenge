...
{
    public interface ICarrierReportService : IGenericRepository<CarrierReport>
    {
        Task<CustomResponseDto<NoContentDto>> HangfireStart();
        Task<CustomResponseDto<NoContentDto>>  Report();
    }
}
